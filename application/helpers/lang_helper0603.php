...
function gettiming($class_id, $section_id)
{
	$CI =& get_instance();
	$CI->load->database();
	...
	$timing = $CI->db->select('weekly_calendar.*, period_timing.period_one_from,period_timing.period_one_to, period_timing.period_two_from,period_timing.period_two_to,period_timing.period_three_from,period_timing.period_three_to,period_timing.period_four_from,period_timing.period_four_from,period_timing.period_four_to,period_timing.period_five_from,period_timing.period_five_to,period_timing.period_six_from,period_timing.period_six_to,period_timing.period_seven_from,period_timing.period_seven_to,period_timing.period_eight_from,period_timing.period_eight_to')
