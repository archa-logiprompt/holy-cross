        ...
        <ul class="sidebar-menu verttop">
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                ...
                                <!-- <li class="<?php echo set_Submenu('temporary_admission/index'); ?>"><a href="<?php echo base_url(); ?>admin/temporary_admission/search"><i class="fa fa-angle-double-right"></i>
                                        <?php echo "Temporary Student Details"; ?></a></li> -->
            ...
            if ($this->module_lib->hasActive('academics')) {
                if (($this->rbac->hasPrivilege('class_timetable', 'can_view') ||
                    ...
                    $this->rbac->hasPrivilege('print_timetable', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                           ...
                           href="<?php //echo base_url(); 
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('weeklycalendarnew/print_timetable'); ?>"><a href="<?php echo base_url(); ?>admin/weeklycalendarnew/printtimetable"><i class="fa fa-angle-double-right"></i> Print Timetable </a></li>
                            <?php
                            }
                        }
                ...
                <?php
                    ...
                    if ($this->module_lib->hasActive('human_resource')) {
                        if (($this->rbac->hasPrivilege('staff', 'can_view') ||
                            ...
                            $this->rbac->hasPrivilege('staff_leave_report', 'can_view')
                    ...
                    <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            */
                            ...
                            if ($this->rbac->hasPrivilege('update_attendance', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/staff/updateattendance'); ?>"><a href="<?php echo base_url(); ?>admin/staff/updateattendance"><i class="fa fa-angle-double-right"></i>
                                        <?php echo "Update Attendance"; ?></a></li>
                            <?php
                            }
                            ...
                            <?php }
                             if ($this->rbac->hasPrivilege('staff_leave_report', 'can_view')) {
                                ?>
    
                                    <li class="<?php echo set_Submenu('admin/staff/leavereport'); ?>"><a href="<?php echo base_url(); ?>admin/staff/leavereport"><i class="fa fa-angle-double-right"></i>
                                            <?php echo "Staff Leave Report" ?></a></li>
                                <?php }
                                 if ($this->rbac->hasPrivilege('yearwise_staff_leave_report', 'can_view')) {
                                    ?>
        
                                        <li class="<?php echo set_Submenu('admin/staff/yearwise_staff_leave_report'); ?>"><a href="<?php echo base_url(); ?>admin/staff/yearwise_staff_leave_report"><i class="fa fa-angle-double-right"></i>
                                                <?php echo "Year Wise Staff Leave Report" ?></a></li>
                                    <?php }
                            ?>
