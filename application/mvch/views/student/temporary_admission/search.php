...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> <?php echo "Temporary Student Details" ?> <small><?php echo $this->lang->line('student1'); ?></small></h1>
    </section>
    <!-- Main content -->
                                ...
                                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>admin/temporary_admission/view/<?php echo $student['id']; ?>"><?php echo $student['firstname'] . " " . $student['lastname']; ?>
                                                        </a>
                                                    </td>
                                        ...
                                        if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                            ?>
                                                        <a href="<?php echo base_url(); ?>admin/temporary_admission/edit/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
