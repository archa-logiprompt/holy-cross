...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i> <?php echo "Subject Hours" ?>
            ...
            <div class="box-header with-border">
                    ...
                    <table border=1 style="align-items: center;" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php } ?>
                                <td style="text-align: center;"><?php echo getsubjectcode($subject['subject_id']) ?></td>
                ...
                <?php if($theory_credits_sum!=0 && $theory_hours!=0 && $lab_credits!=0 && $lab_hours!=0 && $clinical_credits!=0 && $clinical_hours!=0 ){ ?>
                            <tr class='totalrow'>
                                ...
                                <td class='bold'  style="text-align: center;"> <?php  echo $theory_credits_sum; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $theory_hours; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $lab_credits; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $lab_hours; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $clinical_credits; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $clinical_hours; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $theory_credits_sum+$lab_credits+$clinical_credits; ?></td>
                                <td class='bold'  style="text-align: center;"> <?php  echo $theory_hours+$lab_hours+$clinical_hours; ?></td>
