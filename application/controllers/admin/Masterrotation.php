...
//         $datefrom_a = strtotime($a['datefrom']);
//         $datefrom_b = strtotime($b['datefrom']);
//         $dateto_a = strtotime($a['dateto']);
//         $dateto_b = strtotime($b['dateto']);
//         return $datefrom_a <=> $datefrom_b ?: $dateto_a <=> $dateto_b;
//     });
// }
