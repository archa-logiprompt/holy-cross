...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-sitemap"></i> <?php echo "Department"; ?>
        </h1>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/department/department') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('department'); ?> Code</label><small class="req"> *</small>
                                    <input autofocus="" id="code"  name="code" placeholder="" type="text" class="form-control"  value="<?php
                                    if (isset($result)) {
                                        echo $result["department_code"];
                                    }
                                    ?>" />
                                    <span class="text-danger"><?php echo form_error('code'); ?></span>

                                    <input autofocus="" id="department_code"  name="department_code" placeholder="" type="hidden" class="form-control"  value="<?php
                                    if (isset($result)) {
                                        echo $result["id"];
                                    }
                                    ?>" />
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('department'); ?> Code</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($departmenttype as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> <?php echo $value['department_code'] ?></td>
