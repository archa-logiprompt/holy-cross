...
<div class="content-wrapper" style="min-height: 946px;">
                    ...
                    <button type="button" style="margin-right: 10px; margin-top: 10px;" name="search"
                        ...
                        <div class="box-body" id="collection_report">
                            ...
                            <div class="row">
                                ...
                                <div id='printcontent'>
                                    <div>
                                        <p style="margin: 0;padding-top:40px"><span>Programme And Batch: </span><b> <?php echo "$class_name $section_name" ?></b></p>
                                    ...
                                    <div style="width: 100%; overflow-x: auto;margin-top: 0px;">
                                        ...
                                        <h4> Week: <?php echo $dateStart.'-'.$dateEnd ?></h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">I<sup>st</sup> Period <br> 08:00 AM - 09:00 AM</td>
                                                    ...
                                                    <tr>
                                                         <td style="text-align:center">II<sup>nd</sup> Period <br>09:00 AM - 10:00 AM</td>
                                                        <!--<td style="text-align:center">-->
                                                        <!--    Subject-->
                                                        <!--    <br>-->
                                                        <!--    Faculty-->
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">III<sup>rd</sup> Period <br>10:30 AM - 11:30 AM</td>
                                                        <!--<td style="text-align:center">-->
                                                        <!--    Subject-->
                                                        <!--    <br>-->
                                                        <!--    Faculty-->
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">IV<sup>th</sup> Period <br>11:30 AM - 12:30 PM</td>
                                                        <!--<td style="text-align:center">-->
                                                        <!--    Subject-->
                                                        <!--    <br>-->
                                                        <!--    Faculty-->
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">V<sup>th</sup> Period <br>01:30 PM - 02:30 PM</td>
                                                        <!--<td style="text-align:center">-->
                                                        <!--    Subject-->
                                                        <!--    <br>-->
                                                        <!--    Faculty-->
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">VI<sup>th</sup> Period <br>02:30 PM - 03:30 PM</td>
                                                        <!--<td style="text-align:center">-->
                                                        <!--    Subject-->
                                                        <!--    <br>-->
                                                        <!--    Faculty-->
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">VII<sup>th</sup> Period<br>03:30 PM - 04:30 PM</td>
                                                        <!--<td style="text-align:center">-->
                                                        <!--    Subject-->
                                                        <!--    <br>-->
                                                        <!--    Faculty-->
    ...
    foreach ($weekcalendar as $key => $value) {
        if (isset($daysvalue[$days]) && $value['date'] == $daysvalue[$days]) {
            ?>
            <td style="text-align:center">
                <?php 
                echo ($subjectName = getsubjectname($value['eight_to_nine_subject'])) !== null 
                    ? $subjectName 
                    : $value['eight_to_nine_activity']; 
                ?>
                <br>
                <?php echo getteacheranme($value['eight_to_nine_teacher'])[0]->name; ?>
