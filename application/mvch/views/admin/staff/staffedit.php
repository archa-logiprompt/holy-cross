...
<?php } ?> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputFile"><?php echo "Staff Type:"; ?></label>
                                                <input type="radio" id="html" name="staff_type" value="1" <?php if($staff['staff_type']==1)echo"checked" ?>>
                                                <label for="html">Teaching</label>
                                                <input type="radio" id="css" name="staff_type" value="0" <?php if($staff['staff_type']==0)echo"checked" ?>>
                                                <label for="css">Non-Teaching</label><br>
                                                <span class="text-danger"></span></div>
                                        </div> 
