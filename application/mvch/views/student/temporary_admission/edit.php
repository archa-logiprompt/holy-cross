                            ...
                            <div class="tshadow mb25 bozero"> 
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo 'Centre/Board Reg Number'; ?></label><small class="req"> *</small>
                                                <input autofocus="" id="kuhs_reg" name="kuhs_reg" placeholder="" type="text" class="form-control"  value="<?php echo set_value('kuhs_reg', $student['kuhs_reg']); ?>" />
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo 'Age'; ?></label><small class="req"> *</small>
                                                <input id="age" name="age" placeholder="" type="text" class="form-control"   value="<?php echo set_value('age', $student['age']); ?>"/>
                                                <span class="text-danger"><?php echo form_error('dob'); ?></span>
                                            </div>
                                        </div>
                  ...
                  <td>
                      <div class="form-group">
                          <input type="text" id="med_total" class="form-control eng-percentage" name="med_total_year" value="<?php echo $student['med_total_year']; ?>" />
                            ...
                            <div class="tshadow mb25 bozero">
                                <h3 class="pagetitleh2"><?php echo'NEET DETAILS'; ?></h3>
                                <div class="around10">  
                                <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo 'Neet Registration Number'; ?></label><small class="req"> *</small>
                                                <input autofocus="" id="neet_reg" name="neet_reg" placeholder="" type="text" class="form-control"  value="<?php echo set_value('neet_reg', $student['neet_reg']); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="neet_rank" name="neet_rank" placeholder="" type="text" class="form-control"  value="<?php echo set_value('neet_rank', $student['neet_rank']); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo 'Neet Mark'; ?></label>
                                                <input id="neet_marks" name="neet_marks" placeholder="" type="text" class="form-control"  value="<?php echo set_value('neet_marks', $student['neet_marks']); ?>" />
                ...
                <div class="col-md-12">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <div class="tshadow mb25 bozero">
                                <h3 class="pagetitleh2"><?php echo'KEAM DETAILS'; ?></h3>
                                <div class="around10">  
                                <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo 'Keam Roll Number'; ?></label><small class="req"> *</small>
                                                <input autofocus="" id="keam_roll_no" name="keam_roll_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('keam_roll_no', $student['keam_roll_no']); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="kerala_medical_rank" name="kerala_medical_rank" placeholder="" type="text" class="form-control"  value="<?php echo set_value('kerala_medical_rank', $student['kerala_medical_rank']); ?>" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo 'Seat Type AIQ/Open merit/NRI'; ?></label>
                                                <input id="seat_type" name="seat_type" placeholder="" type="text" class="form-control"  value="<?php echo set_value('seat_type', $student['seat_type']); ?>" />
                            ...
                            <div class="tshadow mb25 bozero">
                                <h3 class="pagetitleh2"><?php echo'BANK ACCOUNT NUNMBER'; ?></h3>
                                <div class="around10">  
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
